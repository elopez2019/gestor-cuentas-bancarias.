package com.example.application.views.entidadbancaria;
...
@PageTitle("Entidad Bancaria")
@Route(value = "entidadBancaria", layout = MainLayout.class)
@RouteAlias(value = "", layout = MainLayout.class)
public class EntidadBancariaView extends Div {
    ...
    public EntidadBancariaView() {
        addClassName("entidad-bancaria-view");
        setSizeFull();
        createGrid();
        add(grid);
    }
