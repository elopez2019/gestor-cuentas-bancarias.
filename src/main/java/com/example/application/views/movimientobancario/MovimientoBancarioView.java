package com.example.application.views.movimientobancario;
...
@PageTitle("Movimiento Bancario")
@Route(value = "movimientoBancario", layout = MainLayout.class)
public class MovimientoBancarioView extends Div {
    ...
    public MovimientoBancarioView() {
        addClassName("movimiento-bancario-view");
        setSizeFull();
        createGrid();
        add(grid);
    }
